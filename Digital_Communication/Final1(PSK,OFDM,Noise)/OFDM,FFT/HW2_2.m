...
for i=0:1:N_OFDM_symbols-1
    %%Calculate
    %Fetch A OFDM Symbol
    A_OFDM_Symbol_GI=Data([1,i*Length_OFDM_Symbol+1:(i+1)*Length_OFDM_Symbol-1]);
    %Remove Cyclic Prefix
    A_OFDM_Symbol=A_OFDM_Symbol_GI(1,[nSampGI+1:end]);
    %Serial to Parallel
...
Data_reshaped=(reshape(Data_row_Se',[N_ASCII_Bits,length(Data_row(:))/N_ASCII_Bits]))';
